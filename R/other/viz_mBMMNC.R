...
load(file='../../Data/RData/mouseBMMNC-Seurat.RData')

## Load Packages
dev_lib <- "/usr/local/lib/R/4.0/dev-library"
library(Seurat, lib.loc = dev_lib) # Single-cell RNA-seq analysis package by Satija group
